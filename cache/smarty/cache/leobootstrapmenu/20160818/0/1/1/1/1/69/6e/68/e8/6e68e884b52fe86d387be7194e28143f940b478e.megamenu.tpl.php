...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57b6204f73fa03_81659683',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57b6204f73fa03_81659683')) {function content_57b6204f73fa03_81659683($_smarty_tpl) {?><div id="leo-megamenu" class="clearfix">
        ...
        <div id="leo-top-menu" class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav megamenu"><li class="home" >
                    ...
                    <a href="" class="dropdown-toggle has-category" data-toggle="dropdown" target="_self"><span class="menu-title">En venta</span><b class="caret"></b></a><div class="dropdown-sub dropdown-menu"  style="width:850px" ><div class="dropdown-menu-inner"><div class="row"><div class="mega-col col-sm-3" > <div class="mega-col-inner "><div class="leo-widget">No hay se encuentra plantilla para el m&oacute;dulo leobootstrapmenu</div><div class="leo-widget">No hay se encuentra plantilla para el m&oacute;dulo leobootstrapmenu</div></div></div><div class="mega-col col-sm-5" > <div class="mega-col-inner "><div class="leo-widget">No hay se encuentra plantilla para el m&oacute;dulo leobootstrapmenu</div></div></div><div class="mega-col col-sm-4" > <div class="mega-col-inner "><div class="leo-widget">No hay se encuentra plantilla para el m&oacute;dulo leobootstrapmenu</div></div></div></div></div></div></li><li class="" >
						<a href="blog.html" target="_self" class="has-category"><span class="menu-title">Blog</span></a></li><li class="parent dropdown  aligned-left" ><a class="dropdown-toggle has-category" data-toggle="dropdown" href="" target="_self"><span class="menu-title">Caracteristicas</span><b class="caret"></b></a><div class="dropdown-menu level1"  ><div class="dropdown-menu-inner"><div class="row"><div class="mega-col col-sm-12" data-type="menu" ><div class="mega-col-inner "><ul><li class="parent dropdown-submenu  " ><a class="dropdown-toggle" data-toggle="dropdown" href=""><span class="menu-title">Café exprés</span><b class="caret"></b></a><div class="dropdown-menu level2"  ><div class="dropdown-menu-inner"><div class="row"><div class="mega-col col-sm-12" data-type="menu" ><div class="mega-col-inner "><ul><li class="  " ><a href="" target="_self><span class="menu-title">Espresso Yen</span></a></li><li class="  " ><a href="" target="_self><span class="menu-title">Americano</span></a></li><li class="  " ><a href="" target="_self><span class="menu-title">Café helado</span></a></li></ul></div></div></div></div></div></li><li class="  " ><a href="" target="_self><span class="menu-title"> Té de oolong</span></a></li><li class="  " ><a href="http://190.60.31.15/bocatelly/index.php?id_category=12&controller=category" target="_self><span class="menu-title">Espresso bebidas</span></a></li></ul></div></div></div></div></div></li><li class="" >
						<a href="contact-us" target="_self" class="has-category"><span class="menu-title">contacto</span></a></li></ul>
        </div>
    </div>
</nav>
</div>
