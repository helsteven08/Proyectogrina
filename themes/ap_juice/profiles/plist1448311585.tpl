...
{if isset($comparator_max_item) && $comparator_max_item}
		...
		<a class="add_to_compare compare button btn" href="{$product.link|escape:'html':'UTF-8'}" data-id-product="{$product.id_product}" title="{l s='Add to compare'}"><span><i class="fa fa-retweet"></i></span></a>
