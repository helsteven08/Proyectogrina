...
{if $return_allowed}
	<div id="returnOrderMessage">
		...
		<p class="form-group">
			<button type="submit" name="submitReturnMerchandise" class="btn btn-outline button button-small btn-sm"><span>{l s='Make an RMA slip'}<i class="icon-chevron-right right"></i></span></button>
