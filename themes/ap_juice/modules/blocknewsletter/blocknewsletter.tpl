...
<div id="newsletter_block_left" class="block inline">
	<h4 class="title_block">{l s='Newsletter' mod='blocknewsletter'}</h4>
    	<div class="block_content">
    		<p class="new-des">{l s='Signup to receive our latest news and promotion. We never send spam!' mod='blocknewsletter'}</p>
		<form action="{$link->getPageLink('index', null, null, null, false, null, true)|escape:'html':'UTF-8'}" method="post">
			<div class="form-group{if isset($msg) && $msg } {if $nw_error}form-error{else}form-ok{/if}{/if}" >
                ...
                <button type="submit" name="submitNewsletter" class="btn button button-small">
                    ...
                    <span>{l s='Register' mod='blocknewsletter'}</span>
                </button>				
