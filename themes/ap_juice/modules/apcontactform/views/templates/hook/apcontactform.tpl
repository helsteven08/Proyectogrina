...
{if isset($confirmation)}
	<ul class="footer_links clearfix">
		<li>
			<a class="btn btn-outline button button-small" href="{$base_dir}">{* HTML form , no escape necessary *}
				<span>
					{l s='Home' mod='apcontactform'}
				</span>
			</a>
		</li>
	</ul>
		...
		<fieldset>
			<div class="contact-content">
				<div class="row">
					...
					<div class="col-xs-12 col-md-12 col-lg-10 col-ms-12">
						<div class="form-group">
							<label for="message">{l s='Message' mod='apcontactform'}</label>
							<textarea class="form-control" id="message" name="message">{if isset($message)}{$message|escape:'html':'UTF-8'|stripslashes}{/if}</textarea>
						</div>
						<div class="submit">
							<button type="submit" name="submitMessage" id="submitMessage" class="button btn btn-inverse button-medium"><span>{l s='send message' mod='apcontactform'}</span></button>
						</div>
					</div>	
				</div>
			</div>		
