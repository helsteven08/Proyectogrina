		...
		<table id="cart_summary" class="table table-bordered {if $PS_STOCK_MANAGEMENT}stock-management-on{else}stock-management-off{/if}">
			<thead>
				<tr>
					...
					<th class="cart_delete last_item text-center">{l s='Delete'}</th>
										...
										<div class="cart_quantity_button clearfix">
											{if $product.minimal_quantity < ($customization.quantity -$quantityDisplayed) OR $product.minimal_quantity <= 1}
												<a
													...
													class="cart_quantity_down button-minus btn-sm"
											...
											{else}
												<a
													...
													class="cart_quantity_down button-minus btn-sm disabled"
													href="#"
													title="{l s='Subtract'}">
													<span><i class="fa fa-minus"></i></span>
												</a>
											...
											<a
												...
												class="cart_quantity_up button-plus btn-sm"
