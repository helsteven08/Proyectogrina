										...
										<div class="product-image-container image ImageWrapper">
											...
											<div class="Buttons StyleC">
												{if isset($quick_view) && $quick_view}
													<a class="quick-view WhiteRounded" href="{$accessory.link|escape:'html':'UTF-8'}" rel="{$accessory.link|escape:'html':'UTF-8'}" data-original-title="{l s='Quick view'}" title="{l s='Quick view'}">
